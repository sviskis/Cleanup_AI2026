...
# ---------------------------------------------------------------- readme
$bt = [char]96   # backtick: avoids every PowerShell escaping pitfall below
$readme = New-Object System.Collections.ArrayList
[void]$readme.Add("# Legacy - frozen working version")
[void]$readme.Add("")
[void]$readme.Add($bt + "current_working_v10.jsx" + $bt + " is the **frozen, standalone snapshot of the working")
[void]$readme.Add("Illustrator application** (the multi module app under " + $bt + "src/" + $bt + "), generated by")
[void]$readme.Add($bt + "tools/freeze_legacy.ps1" + $bt + ", which inlines every " + $bt + "#include" + $bt + " in order.")
[void]$readme.Add("")
...
[void]$readme.Add("| Source entry point | " + $bt + $Entry + $bt + " |")
[void]$readme.Add("| Git commit | " + $bt + $commit + $bt + " |")
[void]$readme.Add("| Modules inlined | " + $ordered.Count + " |")
[void]$readme.Add("| Lines | " + $lineCount + " |")
[void]$readme.Add("| SHA256 | " + $bt + $hash + $bt + " |")
[void]$readme.Add("")
...
[void]$readme.Add("")
[void]$readme.Add("* **Do not edit this file.** It is generated; edit " + $bt + "src/" + $bt + " and re-freeze.")
[void]$readme.Add("* Do not delete it: it is the regression baseline (cases R1-R5 in " + $bt + "docs/TESTING.md" + $bt + ").")
[void]$readme.Add("* The older monoliths stay in " + $bt + "archive/original/" + $bt + " (read only, hashes in")
[void]$readme.Add("  " + $bt + "archive/original/ARCHIVE_MANIFEST.md" + $bt + "). They are predecessors, not the baseline.")
[void]$readme.Add("")
